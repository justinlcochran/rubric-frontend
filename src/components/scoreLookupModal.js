...
function ScoreLookupModal({ scoreLookupModal, setScoreLookupModal }) {
    ...
    return (
        <div className={"fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center flex flex-col z-10"} id="wrapper">
            <div className={"flex flex-col"}>
                <div className={"relative bg-gray-200 p-2 m-4 rounded p-2 w-full"}>
