    ...
    return (
        (Object.keys(submission).includes(`criterion${criterionID}`)) ? (submission[`criterion${criterionID}`].score == 1) ?
                ...
                <div className={'col-span-5 grid grid-cols-5 pt-4 bg-red-300 min-h-full rounded shadow border-4 border-slate-300 text-xl'}>
                    ...
                    <div className={'col-span-1 align-bottom mt-auto text-center bg-red-300 py-4 drop-shadow-xl border-b-4 border-white'} id={1}>1</div>
                    <div className={'col-span-1 align-bottom mt-auto text-center bg-orange-300 py-4'} id={2}>2</div>
                    <div className={'col-span-1 align-bottom mt-auto text-center bg-amber-300 py-4'} id={3}>3</div>
                    <div className={'col-span-1 align-bottom mt-auto text-center bg-lime-300 py-4'} id={4}>4</div>
                    <div className={'col-span-1 align-bottom mt-auto text-center bg-green-300 py-4'} id={5}>5</div>
                ...
                : (submission[`criterion${criterionID}`].score == 2) ?
                    <div className={'grid grid-cols-5 pt-4 bg-orange-300 min-h-full rounded shadow border-4 border-slate-300 text-xl'}>
                        ...
                        <div className={'align-bottom mt-auto text-center bg-red-300 py-4 select-none'} id={1}>1</div>
                        <div className={'align-bottom mt-auto text-center bg-orange-300 py-4 drop-shadow-xl border-b-4 border-white select-none'} id={2}>2</div>
                        <div className={'align-bottom mt-auto text-center bg-amber-300 py-4 select-none'} id={3}>3</div>
                        <div className={'align-bottom mt-auto text-center bg-lime-300 py-4 select-none'} id={4}>4</div>
                        <div className={'align-bottom mt-auto text-center bg-green-300 py-4 select-none'} id={5}>5</div>
                        <RubricAid bottom={bottom} middle={middle} top={top} />
                    </div>
                    : (submission[`criterion${criterionID}`].score == 3) ?
                        <div className={'grid grid-cols-5 pt-4 bg-amber-300 min-h-full rounded shadow border-4 border-slate-300 text-xl'}>
                            ...
                            <div className={'align-bottom mt-auto text-center bg-red-300 py-4 select-none'} id={1}>1</div>
                            <div className={'align-bottom mt-auto text-center bg-orange-300 py-4 select-none'} id={2}>2</div>
                            <div className={'align-bottom mt-auto text-center bg-amber-300 py-4 drop-shadow-xl border-b-4 border-white select-none'} id={3}>3</div>
                            <div className={'align-bottom mt-auto text-center bg-lime-300 py-4 select-none'} id={4}>4</div>
                            <div className={'align-bottom mt-auto text-center bg-green-300 py-4 select-none'} id={5}>5</div>
                            <RubricAid bottom={bottom} middle={middle} top={top} />
                        </div>
                        : (submission[`criterion${criterionID}`].score == 4) ?
                            <div className={'grid grid-cols-5 pt-4 bg-lime-300 min-h-full rounded shadow border-4 border-slate-300 text-xl'}>
                                ...
                                <div className={'align-bottom mt-auto text-center bg-orange-300 py-4 select-none'} id={2}>2</div>
                                <div className={'align-bottom mt-auto text-center bg-amber-300 py-4 select-none'} id={3}>3</div>
                                <div className={'align-bottom mt-auto text-center bg-lime-300 py-4 drop-shadow-xl border-b-4 border-white select-none'} id={4}>4</div>
                                <div className={'align-bottom mt-auto text-center bg-green-300 py-4 select-none'} id={5}>5</div>
                                <RubricAid bottom={bottom} middle={middle} top={top} />
                            </div>
                            :
                            <div className={'grid grid-cols-5 pt-4 bg-green-300 min-h-full rounded shadow border-4 border-slate-300 text-xl'}>
                                ...
                                <div className={'align-bottom mt-auto text-center bg-amber-300 py-4 select-none'} id={3}>3</div>
                                <div className={'align-bottom mt-auto text-center bg-lime-300 py-4 select-none'} id={4}>4</div>
                                <div className={'align-bottom mt-auto text-center bg-green-300 py-4 drop-shadow-xl border-b-4 border-white select-none'} id={5}>5</div>
                                <RubricAid bottom={bottom} middle={middle} top={top} />
                            </div>
            :
