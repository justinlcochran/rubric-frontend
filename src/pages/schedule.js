        ...
        if (data.filter(item => item.schedule === 'Round One').length === 0) {
            return (
                <div className={'flex flex-col h-screen'}>
                    <div className={'grow'}/>
                    <p className={'text-white text-xl mx-2'}>It looks like the schedule isn't up yet! We can't set a
                        schedule until the end of check-in. Check back around 4:35 to find out when you present!</p>
                    <div className={'grow'}/>
                    <button
