        ...
        <div>
            ...
            <div className={"flex w-[80%] mx-auto justify-between"}>
                ...
                <div className={"w-[25%] bg-amber-200 rounded p-4 shadow shadow-lg flex flex-col"}>
                    ...
                    <div className={'m-2 bg-violet-400 font-bold text-white hover:bg-violet-300 cursor-pointer p-2 border-white border-2'}><a target="_blank" rel="noopener noreferrer" href={'https://ucarecdn.com/75fb11e3-fd46-48ad-b914-4128f45106ce/MapletonDistrictScienceFairFlyer.pdf'}>District Fair Flyer (Spanish)</a></div>
