...
export const ScoreProvider = ({children}) => {
    ...
    let rubric = {
        rubricElements: [
            ...
            {text: 'Experiment is Clearly Outlined', criterionID: 8,
                bottom: "Procedure is difficult to navigate",
                middle: "Procedure describes the goals of several steps with low specificity",
                top: "Project includes clear, detailed, and replicable procedure"},
            ...
            {text: 'Organization', criterionID: 13},
            {text: 'Accessibility', criterionID: 14},
            ...
            {text: 'Results Inform Investigation of the Hypothesis', criterionID: 19,
            ...
            {text: 'Data Are Represented Visually', criterionID: 20,
            ...
            {text: 'Clear Conclusions are Drawn', criterionID: 21,
        ...
        categories: [
            ...
            {title: "Experimental Design", criteria: [7, 8, 9, 12]},
            {title: "Results", criteria: [19, 20,]},
            {title: "Conclusions", criteria: [21, 22, 23]},

            {title: "Visual Aid", criteria: [13, 14, 15]},
